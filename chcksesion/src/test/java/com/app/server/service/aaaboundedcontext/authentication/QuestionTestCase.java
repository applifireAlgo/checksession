...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("EXERtYPhHiU2sebH9vBkYbSObOWgJaQ0haVwSfQ0WBuVQkdtBP");
        question.setLevelid(9);
        question.setQuestion("8v92hKhQ4zKHKgwRjW20NOE0UNgsi7WxWvjvi48HzOqJaEONqj");
        question.setQuestionDetails("uicDVPcceo");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("gYwKZIajiBhxrStSaNuE8W4TZOFkybbpqWBixRMupLzithW8JJ");
            question.setLevelid(10);
            question.setQuestion("g2Wuuesqz7lqd8UzsfJZbhJvL46X7aeLBfaqWoRTPaQjjUIkqh");
            question.setQuestionDetails("4OO2PEOWA7");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "2SctygiAJzaVGVebZc42TXMIjUq4s1eD4SQ7wzmyzWD6cYK1PDo4LeqRpdUw12T6i"));
