 ...
 */
Ext.define('Chcksesion.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Chcksesion.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Chcksesion.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Chcksesion.view.login.SessionLogin').center();
