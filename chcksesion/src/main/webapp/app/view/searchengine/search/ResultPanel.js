Ext
		.define(
				'Chcksesion.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Chcksesion.view.searchengine.search.SearchEngineMainPanelController','Chcksesion.view.searchengine.search.PanelHeaderField' ,'Chcksesion.view.searchengine.search.ReportGridView','Chcksesion.view.searchengine.search.ReportChartView','Chcksesion.view.searchengine.search.documentView','Chcksesion.view.searchengine.search.DouMeanView','Chcksesion.view.googlemaps.map.MapPanel'],
