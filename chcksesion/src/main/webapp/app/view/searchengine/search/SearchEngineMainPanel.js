Ext.define('Chcksesion.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Chcksesion.view.searchengine.search.NorthPanel', 'Chcksesion.view.searchengine.search.SearchResult','Chcksesion.view.searchengine.search.SearchEngineMainPanelController'],
