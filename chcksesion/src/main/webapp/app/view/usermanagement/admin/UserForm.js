Ext.define('Chcksesion.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Chcksesion.view.usermanagement.admin.AddUserDetailsViewModel', 'Chcksesion.model.AddUserDataModel' ],
