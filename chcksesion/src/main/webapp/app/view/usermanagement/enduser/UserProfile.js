Ext.define('Chcksesion.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Chcksesion.view.usermanagement.enduser.UserProfileController', 'Chcksesion.view.usermanagement.admin.AddUserDetailsViewModel', 'Chcksesion.model.AddUserDataModel' ],
