...
Ext
		.define(
				'Chcksesion.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Chcksesion.view.logger.tabs.details.DetailsTab',
							'Chcksesion.view.logger.tabs.fileconnector.FileConnectorTab',
							'Chcksesion.view.logger.tabs.dbconnector.DBConnectorTab',
							'Chcksesion.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Chcksesion.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Chcksesion.view.logger.LogConfigurationTabPanelController',
