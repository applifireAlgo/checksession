 ...
 * 
 */
Ext.define('Chcksesion.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Chcksesion.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
