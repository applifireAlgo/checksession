Ext.define('Chcksesion.view.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Chcksesion.view.scheduler.scheduler"
		var component = Ext.create(
				"Chcksesion.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Chcksesion.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
