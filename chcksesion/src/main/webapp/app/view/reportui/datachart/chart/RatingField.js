...
Ext.define('Chcksesion.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Chcksesion.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Chcksesion.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
