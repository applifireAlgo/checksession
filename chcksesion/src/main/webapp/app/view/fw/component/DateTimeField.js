 ...
 */
Ext.define('Chcksesion.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Chcksesion.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Chcksesion.view.fw.component.DateTimePicker(o);
    },
