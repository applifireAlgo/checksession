Ext.define('Chcksesion.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Chcksesion.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Chcksesion.view.console.ConsoleWindow');
