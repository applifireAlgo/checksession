 ...
 * 
 */
Ext.define('Chcksesion.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Chcksesion.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
