 ...
 * 
 */
Ext.define('Chcksesion.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Chcksesion.view.logalarm.mainscreen.AddLogAlarmController',
			'Chcksesion.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Chcksesion.view.logalarm.mainscreen.AppAlarmPanel',
