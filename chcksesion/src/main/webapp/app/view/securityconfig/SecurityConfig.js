 ...
 * 
 */
Ext.define('Chcksesion.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Chcksesion.view.securityconfig.SecurityConfigController',
			'Chcksesion.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
