...
folder are mapped to the application's root namespace, 'Chcksesion'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Chcksesion"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Chcksesion' in the same way
as `"Chcksesion/sass/src"`.
