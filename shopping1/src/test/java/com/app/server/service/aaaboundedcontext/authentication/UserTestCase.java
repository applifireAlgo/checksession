...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccessdomain.setDomainDescription("DHzRfBQYpZP4mVBo3dWA4fAMRlHpVD23flZIc0tSFykZ0H2JhE");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainIcon("hJdLMWHTOIkL5iGIP914vXizxpO79zT63z8p4773t0UVmx2n96");
        useraccessdomain.setDomainHelp("FFwjVBagY0XQf8u3yXJckf3YLOvNagH25XBtqyWfMpQkJXjznD");
        useraccessdomain.setDomainName("VJ6sZSOLJELivWEsgeIybdZ00J3KRm714kAqMzuq3rpcoIQAMR");
        ...
        useraccesslevel.setLevelHelp("JWHGmHPYZbGnVu1BOgPMQt7orPSnUsYDRjabkl4Pcj5sQMbnjs");
        useraccesslevel.setLevelDescription("bJkJrrXPQwO6Uwid83IlQwGNDiRCsFLfzlXyqT8rlNkCOkQh30");
        useraccesslevel.setLevelIcon("bB7c2pEQJl8ywcELikSmQFn7FkKzNiKnoU5l9bsBKGaui56QKN");
        useraccesslevel.setLevelName("5e4JdrHCf1TtMhPKgPfecRLKcczpCOMDgpSjJOooXkeFq0ZuTk");
        ...
        User user = new User();
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459427336756l));
        user.setIsLocked(1);
        user.setUserAccessCode(8);
        user.setGenTempOneTimePassword(1);
        user.setPasswordAlgo("EXlg8COcj3YU1EbONF407hdyyzJ2BpT7bLba01Da4mxnkSv9No");
        user.setChangePasswordNextLogin(1);
        user.setIsDeleted(1);
        user.setSessionTimeout(222);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setMultiFactorAuthEnabled(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459427336953l));
        user.setAllowMultipleLogin(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionIcon("jipfyGfdaxFfyUwd4m91oQUHeFAsF68UbR7ufEV4avw2P7TCdW");
        question.setLevelid(11);
        question.setQuestionDetails("GqBIfNhic8");
        question.setQuestion("CPmkpFSpZo2LFlkJCLN6L8tMs7GrXnVGDhi3ZfbdXh0nqbToLQ");
        ...
        passrecovery.setAnswer("f4FkUxU5HfEZ5sIJeXv1LHauGRs9OctpUsRMEUZzM8zo5e1jg0");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setUser(user);
        userdata.setPassword("27SL71gKT9LBYDZzYsvaxovizHApeg5v9Y5UeiP5HgbLS9uW4I");
        userdata.setOneTimePasswordExpiry(9);
        userdata.setLast5Passwords("vTKhtOu4PY9DWgpgJAZ4tpwlLUSd7Bm9oMfCd5vMNSPDLX6r46");
        userdata.setOneTimePassword("RVRwMkeyuTKgKkQnWVs83omTzaCunoo0");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459427337585l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 16));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "rpwQ44go4zbfLEirInfElX6kamBH3ZG2st8eKTcrRHD1NwR3PmOR1BZaRlldOb31t"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6434));
