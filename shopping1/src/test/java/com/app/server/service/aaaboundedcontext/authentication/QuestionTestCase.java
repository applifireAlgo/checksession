...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("q6lFU8NChB2iuKxoxTzFKAJa3o3PhrShE5qpo3gL9ejUWvIuKE");
        question.setLevelid(4);
        question.setQuestionDetails("opBT7snBNw");
        question.setQuestion("GmjZ4jEKqCYMZhphHZVy2IFCyPd6imgXTxHttn5QzC2KJdiaKd");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("wNZqpDgUsEQy0VrZnytTK0vchP7qo3Zyuh9igV4VE8rb9Lt0w5");
            question.setLevelid(5);
            question.setQuestionDetails("sttpLvWB1f");
            question.setQuestion("NBn4JbegCOaGKquRFJF7VUgqemyiqaopxPwI2Z9HZxrH9SMfy8");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "kXbK0bUYcIuQZtqGDNUZgNvUYWyiBv7pVfjoAo7vp7sqAUKS6fXaEMK8Z1vUsr08Q"));
