...
@SourceCodeAuthorClass(createdBy = "q@yc.com", updatedBy = "", versionNumber = "1", comments = "Repository for AppCustomerCategory Master table Entity", complexity = Complexity.LOW)
