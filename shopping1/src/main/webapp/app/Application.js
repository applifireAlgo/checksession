 ...
 */
Ext.define('Shopping1.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Shopping1.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Shopping1.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Shopping1.view.login.SessionLogin').center();
