 ...
 * 
 */
Ext.define("Shopping1.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Shopping1.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
