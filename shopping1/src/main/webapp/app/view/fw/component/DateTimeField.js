 ...
 */
Ext.define('Shopping1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Shopping1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Shopping1.view.fw.component.DateTimePicker(o);
    },
