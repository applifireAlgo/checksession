Ext.define('Shopping1.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Shopping1.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Shopping1.view.console.ConsoleWindow');
