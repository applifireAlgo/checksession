Ext.define('Shopping1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Shopping1.view.searchengine.search.NorthPanel', 'Shopping1.view.searchengine.search.SearchResult','Shopping1.view.searchengine.search.SearchEngineMainPanelController'],
