Ext
		.define(
				'Shopping1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Shopping1.view.searchengine.search.SearchEngineMainPanelController','Shopping1.view.searchengine.search.PanelHeaderField' ,'Shopping1.view.searchengine.search.ReportGridView','Shopping1.view.searchengine.search.ReportChartView','Shopping1.view.searchengine.search.documentView','Shopping1.view.searchengine.search.DouMeanView','Shopping1.view.googlemaps.map.MapPanel'],
