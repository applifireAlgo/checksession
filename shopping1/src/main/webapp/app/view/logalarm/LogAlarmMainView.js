 ...
 * 
 */
Ext.define('Shopping1.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Shopping1.view.logalarm.LogAlarmMainViewController',
			'Shopping1.view.logalarm.tree.LogAlarmTreePanel',
			'Shopping1.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
