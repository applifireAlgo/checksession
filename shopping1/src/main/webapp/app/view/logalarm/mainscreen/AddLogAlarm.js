 ...
 * 
 */
Ext.define('Shopping1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Shopping1.view.logalarm.mainscreen.AddLogAlarmController',
			'Shopping1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Shopping1.view.logalarm.mainscreen.AppAlarmPanel',
