 ...
 * 
 */
Ext.define('Shopping1.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Shopping1.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
