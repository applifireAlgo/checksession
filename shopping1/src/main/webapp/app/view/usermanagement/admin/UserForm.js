Ext.define('Shopping1.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Shopping1.view.usermanagement.admin.AddUserDetailsViewModel', 'Shopping1.model.AddUserDataModel' ],
