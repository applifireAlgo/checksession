Ext.define('Shopping1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Shopping1.view.usermanagement.admin.UserPasswordReset',
	            'Shopping1.view.usermanagement.admin.AddUserDetails',
	            'Shopping1.view.usermanagement.admin.ViewUser'],
