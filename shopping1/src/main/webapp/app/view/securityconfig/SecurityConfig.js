 ...
 * 
 */
Ext.define('Shopping1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Shopping1.view.securityconfig.SecurityConfigController',
			'Shopping1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
