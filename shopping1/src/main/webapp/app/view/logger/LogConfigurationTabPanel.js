...
Ext
		.define(
				'Shopping1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Shopping1.view.logger.tabs.details.DetailsTab',
							'Shopping1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Shopping1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Shopping1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Shopping1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Shopping1.view.logger.LogConfigurationTabPanelController',
